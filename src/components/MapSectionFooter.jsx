      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-display text-4xl font-bold text-gray-800 mb-4">
            Explore More of Dharamshala
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover the hidden gems and popular spots in Dharamshala. Click on the map to explore locations or check out our list of must-visit places.
          </p>
        </motion.div>
